/*
cd /mnt/c/users/ruedam/Documents/CSCI1020_DS/Labs/Lab10
g++ -g -Wall -std=c++11 test_ds_set.cpp -o test_ds_set.out
./test_ds_set.out
~/DrMemory-Linux-2.4.0-2/bin64/drmemory -brief -- test_ds_set.out
*/

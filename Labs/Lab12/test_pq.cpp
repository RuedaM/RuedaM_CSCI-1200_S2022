/*
cd /mnt/c/users/ruedam/Documents/CSCI1020_DS/Labs/Lab12
g++ -g -Wall -std=c++11 test_pq.cpp -o test_pq.out
./test_pq.out
~/DrMemory-Linux-2.4.0-2/bin64/drmemory -brief -- ./test_pq.out
*/
#include <iostream>
#include <vector>

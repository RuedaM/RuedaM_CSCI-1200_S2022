/*
cd /mnt/c/users/ruedam/Documents/CSCI1020_DS/Labs/Lab14
g++ -g -Wall -std=c++11 simple_main.cpp -o simple_main.out
./simple_main.out simple.txt MY_simple_output.txt
./simple_main.out input.txt MY_input_output.txt
~/DrMemory-Linux-2.4.0-2/bin64/drmemory -brief -- ./simple_main.out
*/
